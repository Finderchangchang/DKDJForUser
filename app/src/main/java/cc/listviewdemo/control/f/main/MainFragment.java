...
import cc.listviewdemo.control.a.main.MainActivity;
...
public class MainFragment extends BaseFragment implements IFMainView {
    ...
    public void initViews() {
        ...
        mListener = new FMainListener(this, MainActivitys.mInstance);
    }
    ...
    public void initEvents() {
        ...
        //附近商家
        mAdapter = new CommonAdapter<Shop>(MainActivitys.mInstance, mShopDetailsList, R.layout.item_main_shop) {
            @Override
        ...
        //商家分类
        mShopTypeAdapter = new CommonAdapter<ShopType>(MainActivitys.mInstance, mShopTypeList, R.layout.item_main_shoptype) {
            @Override
